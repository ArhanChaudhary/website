...
2. Use the followers API endpoint to loop through each user's followers
3. Use the "hack" as described earlier to find each follower's email

# The Script

I decided to write my API scraper in JavaScript so I could utilize [octokit.js](https://github.com/octokit/octokit.js), which provided useful built in functionality such as throttling and retrying.
graphql > rest
