...
It turns out you can still clone this repository. Inspecting the commit history presented something interesting. I won't disclose what for security reasons, because from there I was able to cause...
...
Once I'm given the OK from GitHub to talk about the bug, I'll update this section.
