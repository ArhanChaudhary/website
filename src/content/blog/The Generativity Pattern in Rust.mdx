...
**NOTE: After I published this blog post a commenter realized the current implementation of `generativity` is unsound. It's for a very stinky, but fixable reason. I will update this section to cover the full story sometime in the next few days.**
