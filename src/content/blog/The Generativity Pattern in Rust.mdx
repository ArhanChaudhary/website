...
**NOTE: After publishing this blog post I realized the current implementation of `generativity` is unsound for a very stinky reason, but it is fixable. I will update this section to cover the full story sometime in the next few days.**
