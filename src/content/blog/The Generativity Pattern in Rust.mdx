...
This concludes my first educational write-up on my blog. I came into this topic with surface level understandings of what `generativity`, `PhantomData`, and the drop check are and how they work. I was not expecting this to take five weeks of meticulous research and writing, and I was entirely unprepared for how interesting the full story would be. My posts only get more fun to write >:).
