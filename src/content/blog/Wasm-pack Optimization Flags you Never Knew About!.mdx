...
You have to dig through source to find the full list of `binaryen`'s `wasm-opt` optimization flags. Bizarrely, the only mention of the list is within a test file.
