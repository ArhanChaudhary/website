...
https://github.com/rust-lang/rust/issues/132951

https://github.com/rust-lang/rust/issues/148227
...
<FeatureSummary title="Associated type defaults">
    <Fragment slot="motivation">
        Rust permits associating traits with default `const`s, `fn`s, but not `type`s. We allow `type`s to have defaults to provide more ergonomic APIs.
    </Fragment>
    <Fragment slot="example">
        ```rust
...
<FeatureSummary title="Relink don't rebuild">
    <Fragment slot="motivation">
