...
<ContentVideo
    src={robotArm}
    width="400"
    desc="<a href=https://fizzyapple12.com/>Hazel</a> rescued an abandoned industrial robot arm from the flooded swamps of Florida, brought it to Hack Night, and actually managed to get it working"
/>
...
[^masters]: I have considered saving ECE for my masters. I decided against it because I want to reserve it for something else CS related.
