...
My close friend [Adrian](https://bithole.dev) and I spent three weeks curating a secret message, a string of 30 iconic magic numbers in various fields of computing that only true programming hobbyists can decipher. If you think you're into computers, I challenge you to fully decipher my secret message in under 40 guesses.
